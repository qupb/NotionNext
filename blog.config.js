...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '波波', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '而立少年，勇往直前', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://boqu.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '波波的博客, Notion, 博客', // 网站关键词 英文逗号隔开
